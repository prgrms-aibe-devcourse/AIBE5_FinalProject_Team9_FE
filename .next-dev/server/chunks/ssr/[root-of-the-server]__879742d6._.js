...
const useAuth = ()=>{
    ...
    const handleLogin = async (credentials, role = 'member')=>{
        ...
        try {
            const profile = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$authService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getMe"])();
            currentUser = {
                ...initialUser,
                ...profile
            };
